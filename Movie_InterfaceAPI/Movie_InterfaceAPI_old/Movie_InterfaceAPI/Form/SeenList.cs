...
namespace Movie_InterfaceAPI
{
    public partial class SeenList : Form
    {
        ...
        private void WishList_Load(object sender, System.EventArgs e)
        {
            ...
            {
                string url = OMDB.singleAddress + title + "&apikey=" + OMDB.api;
                ...
                using (WebClient wc = new WebClient())
                {
                    ...
                    MovieUC MovieUserControl = new MovieUC(Entity_S.Title, Entity_S.Year, Entity_S.Poster, Entity_S.Type, Main.TitleInWishList(Entity_S.Title), Main.TitleInSeenList(Entity_S.Title), Main);
